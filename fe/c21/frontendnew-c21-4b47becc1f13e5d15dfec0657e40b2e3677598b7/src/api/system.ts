...
export function resetAllPwds(pwd: string) {
  return axios.post<UserList>('/api/system/user/resetpwds', {
    pwd,
  });
}
...
export function queryAuditList(params: AuditListParams) {
  return axios.post<AuditList>('/api/system/audit/list', params);
}
