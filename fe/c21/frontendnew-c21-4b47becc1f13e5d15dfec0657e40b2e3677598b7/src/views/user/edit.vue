      ...
      <div class="wrapper">
        <a-form ref="formRef" :model="formData" class="form" :label-col-props="{ span: 4 }" :wrapper-col-props="{ span: 18 }" >
          ...
          <a-form-item field="team_id" label="团队">
            <a-select v-model="formData.team_id" :options="allTeam" placeholder="请选择" allow-clear  :disabled="route.name=='Userpreview'"/>
          </a-form-item>
          <a-form-item field="parent_id" label="上级">
            <a-select v-model="formData.parent_id" :options="allUser" placeholder="请输入" allow-clear  :disabled="route.name=='Userpreview'"/>
          </a-form-item>
          <a-form-item>
            <a-space>
