...
class AuthMiddleware
{
    ...
    private $whiteList = ['user/menu', 'user/online', 'user/info', 'user/resetpassword', 'message/unreadlist', 'message/list', 'message/read', 'user/dashboard', 'custom/getnoticelist', 'custom/call', 'custom/data'];
