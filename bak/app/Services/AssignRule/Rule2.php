...
class Rule2
{
    public function handle($config) {
        ...
        $sql = "select * from customer where follow_user_id > 0 and follow_status not in (10,4,5) and assign_time < ? and follow_time < ?  and follow_time < assign_time  and user_from = 1 and `lock` = 0"; 
