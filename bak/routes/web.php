...
$router->post('/api/zy/order', 'Third\ZyController@order');

$router->post('/api/lyh/order', 'Third\LyhController@order');
$router->post('/api/lyh/check_user', 'Third\LyhController@checkUser');

$router->post('/api/user/login', 'UserController@login');
$router->post('/api/customer/push', 'ApiController@push');
$router->post('/api/customer/check', 'ApiController@check');
$router->post('/api/customer/check8', 'ApiController@check8');
$router->post('/api/customer/check_r360', 'ApiController@check_r360');
...
$router->post('/api/custom/dengji', 'CustomController@dengji');
...
$router->post('/api/app/callrecord', 'AppController@callrecord');
$router->post('/api/app/userinfo', 'AppController@userinfo');


$router->post('/api/r360/check_user', 'Third\R360Controller@checkUser');
$router->post('/api/xd/check_user', 'Third\XdController@checkUser');
$router->post('/api/xd/order', 'Third\XdController@apply');

$router->post('/api/lt/order', 'Third\LtController@order');
$router->post('/api/lt/check_user', 'Third\LtController@checkUser');
...
$router->group(['prefix' => 'api', 'middleware'=>'auth'], function () use ($router) {
    ...
    $router->post('system/user/onoffline', 'SystemUserController@onoffline');
    ...
    $router->get('custom/calllist', 'CustomController@calllist');
    $router->get('custom/viewrecord', 'CustomController@viewrecord');
    ...
    $router->get('data/analyst', 'DataController@analyst');
    $router->get('data/channelanalyst', 'DataController@channelanalyst');
    $router->get('data/workuserlist', 'DataController@workuserlist');
